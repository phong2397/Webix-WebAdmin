...
import { order3 } from "models/order3";
import "webix/photo";
...
export default class Disburse extends JetView {
    config() {
        return {
            cols: [{
                rows: [

                    {
                      ...
                      localId:"data2",
                        ...
                        columns: [
                            ...
                            {
                                id: "mid", header: ["mID", { content: "multiSelectFilter" }],
            ...
            },
            {
                ...
                rows: [
                    ...
                    },
                    {
                        ...
                        rows: [
                            {
                                css: "header", header: "Basic Info", id: "item", body: {
                                    view: "form", complexData: true, id: "form1", scroll: true, elementsConfig: {
                                        labelWidth: 130,
                                    }, elements: [  
                                        {
                                            cols:[
