                ...
                rows: [{
                        cols: [{
                            ...
                            },
                            {
                                view: "button",
                                tooltip: "Delete",
                                label: "<span class='webix_icon wxi-plus'></span><span class='text'>Thêm công ty</span>",
                                click: () => {
                                    $$("btn2").show()
                                }
                            },
                    ...
                    },
                    {
                        ...
                        ready: function() {
                            // apply sorting
                            this.data.sort([{ by: "activedDate", dir: "desc", as: "date" }, { by: "companyId", dir: "desc", as: "int" }, ]);
...
export function createDetailUIObject() {
    ...
    let form = keysDetail.map(key => ({ view: 'text', name: key, label: objectNamed[key], labelWidth: 150 }));
    return {
        cells: [{
                id: "btn",
                view: "accordion",
